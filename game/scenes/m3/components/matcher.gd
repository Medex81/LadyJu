# Компонент сматчивает предметы с этим компонентом и одинаковым именем.
...
func _on_collision_ready() -> void:
	_directs = {EDirect.LEFT:$collision/rc_l, EDirect.RIGHT:$collision/rc_r, EDirect.DOWN:$collision/rc_d, EDirect.TOP:$collision/rc_t}
